...
print("{} testing examples loaded".format(len(testing_set)))
...
print("{} training examples loaded".format(len(training_set)))
...
print("Reduced training set: {} training examples".format(len(training_set_reduced)))
...
labels = [int(element[2]) for element in arr]
labels = list(labels)
