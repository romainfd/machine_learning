# -*- coding: utf-8 -*-
"""
Created on Sat Dec 20 11:53:41 2014
...
def load_mnist(dataset, digits=None, path='./kmeans', asbytes=False, selection=None, return_labels=True, return_indices=False):
    """
